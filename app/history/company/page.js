...
export default function CompanyHistoryPage() {
    ...
    const fetchHistory = async () => {
        try {
            ...
            // STRICT FILTER: Only show company bills
            const companyBills = data.filter(b => b.fullState?.type === 'company');
            setHistoryList(companyBills);
        } catch (e) {
    ...
    if (isLoading) return <div style={{ color: 'white', padding: 50 }}>Loading Company History...</div>;
        ...
        <main style={{ overflow: 'auto', height: '100vh', width: '100%' }}>
            <div className="history-container">
                <header className="history-page-header">
                    <h1><i className="fa-solid fa-clock-rotate-left"></i> Company Invoice History</h1>
                    <Link href="/company">
